            ...
            <div class="fc-modal-body" style="padding: 25px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                    <div class="fc-form-group">
                        ...
                        <div style="position:relative;">
                            ...
                            <input type="number" id="editPurchaseCost" class="fc-input" value="${ing.cost}" style="padding-left:35px;" oninput="updateBaseCostPreview()" onfocus="if(this.value==this.defaultValue) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue; updateBaseCostPreview();">
                        </div>
                    </div>
                    <div class="fc-form-group">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                    <div class="fc-form-group">
                        ...
                        <div style="display:flex; gap:5px;">
                            <input type="number" id="editPurchaseWeight" class="fc-input" value="1" step="0.01" oninput="updateBaseCostPreview()" onfocus="if(this.value==this.defaultValue) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue; updateBaseCostPreview();">
                    ...
                    <div class="fc-form-group" id="yieldContainer" style="display:none;">
                        ...
                        <input type="number" id="editYieldQty" class="fc-input" value="1" step="0.01" oninput="updateBaseCostPreview()" onfocus="if(this.value==this.defaultValue) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue; updateBaseCostPreview();">
                ...
                <div class="fc-form-group" style="margin-bottom: 25px;">
                    ...
                    <input type="number" id="editMinStock" class="fc-input" value="${ing.min_stock}" onfocus="if(this.value==this.defaultValue) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue;">
                </div>
                ...
                <div class="fc-form-group" style="margin-bottom:25px; border-top: 1px dashed var(--fc-border); padding-top: 20px;">
                    ...
                    <input type="number" id="editStock" class="fc-input" value="0" onfocus="if(this.value==this.defaultValue) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue;">
